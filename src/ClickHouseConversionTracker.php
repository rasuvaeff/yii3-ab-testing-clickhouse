 ...
 * conversions table with exactly {@see COLUMNS} in this order; the `ts` column
 * is filled server-side by a `DEFAULT now()`.
 *
 * @api
 */
final class ClickHouseConversionTracker implements ConversionTracker, FlushableTracker
{
    /**
     ...
     * @var list<string>
     */
    public const array COLUMNS = ['experiment', 'variant', 'subject_id', 'goal', 'is_forced', 'is_fallback', 'is_sticky', 'environment'];
